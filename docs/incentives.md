...
## Round 1 — announced, funding pending

[The complete allocation and 60 bounty links](https://github.com/0xSachinK/openplaid/issues/64) cover 41 geographies: **20 × $200 + 40 × $150 = $10,000 USD**. No integration award exceeds $200. Funding is planned for September 24, 2026 (Asia/Bangkok), but has not been deposited or escrowed. Each issue is marked `funding-pending`; wait for explicit funding confirmation before starting paid work.
...
Round 1 has a planned $10,000 award budget; **funds have not been deposited**. Tax, wallet or payout onboarding is for the recipient to complete directly when a funded reward exists.
